...
class DirectLinkMaintenanceRequest extends AbstractDirectLinkRequest
{
    ...
    final public const TEST = "https://secure.ogone.com/ncol/test/maintenancedirect_utf8.asp";
    final public const PRODUCTION = "https://secure.ogone.com/ncol/prod/maintenancedirect_utf8.asp";

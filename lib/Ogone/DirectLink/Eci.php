...
class Eci implements \Stringable
{
    ...
    final public const MANUALLY_KEYED = 1;
    ...
    final public const MERCHANT_IDENTIFICATION_3DSECURE = 6;
    ...
    final public const ECOMMERCE_WITH_SSL = 7;
    ...
    final public const ECOMMERCE_RECURRING = 9;
